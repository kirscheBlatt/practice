...
public class Peripheral extends Activity implements ServiceFragment.ServiceFragmentDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.fragment_container, (Fragment)mCurrentServiceFragment, CURRENT_FRAGMENT_TAG)
                    .commit();
        } else {
            mCurrentServiceFragment = (ServiceFragment) getFragmentManager().findFragmentByTag(CURRENT_FRAGMENT_TAG);
        }
